...
#
#    cake_depends_db_add(URL git://git.code.sf.net/p/libpng/code SCRIPT "cake_pkg(INSTALL URL https://github.com/madler/zlib.git")
#
# The macro registers the package identified by the URL and assigns it the ``<script>``. The script will be
# handled just like the cake-depends.cmake script:
# - it will be executed prior to installing the package
# - the package configuration variables you set in the query part of the url will be supplied to the script, like
...
macro(cake_depends_db_add)
  cmake_parse_arguments(_cake_arg "" "URL;SCRIPT" "" ${ARGN})
  if(NOT _cake_arg_URL)
    message(FATAL_ERROR "[cake] cake_depends_db_add: no URL parameter")
  endif()
  if(NOT _cake_arg_SCRIPT)
    message(FATAL_ERROR "[cake] cake_depends_db_add: no SCRIPT parameter")
  endif()
  cake_parse_pkg_url("${_cake_arg_URL}" _ _cake_repo_url_cid _ _)
  set(CAKE_DEPENDS_DB_${_cake_repo_url_cid} "${_cake_arg_SCRIPT}")
endmacro()
